...
function hideForm() {
    ...
    document.querySelector(".main-cont").classList.remove('d-none')
}

function hideCards() {
    document.querySelector("#myForm").classList.remove('d-none')
    document.querySelector(".main-cont").classList.add('d-none')
}
...
document.querySelector("#new_account").onclick = hideCards
document.querySelector("#new_member").onclick = hideCards
